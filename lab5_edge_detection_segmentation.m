...
% --------------------------------------------------------------
% This script performs edge detection using multiple operators,
% applies Otsu thresholding, and visualizes segmented regions.
% --------------------------------------------------------------
...
BW = imbinarize(I,level);  % Binary segmentation
